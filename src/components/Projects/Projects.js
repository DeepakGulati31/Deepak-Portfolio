        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/DeepakGulati31/Resume-Generator"
              demoLink="https://deepakgulati31.github.io/Resume-Generator/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/DeepakGulati31/NotePadia"
              demoLink="https://deepakgulati31.github.io/NotePadia/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/DeepakGulati31/to-do-list-"
              demoLink="https://deepakgulati31.github.io/to-do-list-/"              
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/DeepakGulati31/WorldClock"
              demoLink=" https://deepakgulati31.github.io/WorldClock/"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/DeepakGulati31/Calculator-Using-Js"
              demoLink="https://deepakgulati31.github.io/Calculator-Using-Js/" 
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/DeepakGulati31/ScoreKeeper"
              demoLink="https://deepakgulati31.github.io/ScoreKeeper/"      
            />
          </Col>
        </Row>
      </Container>
